deps_config := \
	...
	drivers/staging/media/imx/hdmirx/Kconfig \
...
ifneq "$(KERNELVERSION)" "5.10.109"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "arm-buildroot-linux-uclibcgnueabihf-gcc"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "arm-buildroot-linux-uclibcgnueabihf-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm"
include/config/auto.conf: FORCE
...
ifneq "$(CC_VERSION_TEXT)" "arm-buildroot-linux-uclibcgnueabihf-gcc.br_real (Buildroot 2022.02-822-g3fa79c038e-dirty) 10.3.0"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "."
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "arm-buildroot-linux-uclibcgnueabihf-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "arm-buildroot-linux-uclibcgnueabihf-objcopy"
include/config/auto.conf: FORCE
endif
