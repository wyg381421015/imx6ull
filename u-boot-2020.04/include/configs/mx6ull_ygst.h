 ...
 */
#ifndef __MX6ULL_YGST_CONFIG_H
#define __MX6ULL_YGST_CONFIG_H
...
#define is_mx6ull_ygst()	CONFIG_IS_ENABLED(TARGET_MX6ULL_YGST)
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"fdt_high=0xffffffff\0" \
	"initrd_high=0xffffffff\0" \
	"fdt_file=imx6ull-ygst-emmc.dtb\0" \
	"fdt_addr=0x83000000\0" \
	"tee_addr=0x84000000\0" \
	...
	"bootscript=echo Running bootscript from mmc ...; " \
		"source\0" \
	"loadimage_ext2=ext2load mmc ${mmcdev}:${mmcpart} ${loadaddr} ${bootdir}/${image}\0" \
	"loadfdt_ext2=ext2load mmc ${mmcdev}:${mmcpart} ${fdt_addr} ${bootdir}/${fdt_file}\0" \
	...
	"ip=dhcp nfsroot=${serverip}:${nfsroot},v3,tcp\0" \
		...
		"findfdt="\
			"if test $fdt_file = undefined; then " \
				"if test $board_name = YGST && test $board_rev = ygst; then " \
					"setenv fdt_file imx6ull-ygst-emmc.dtb; fi; " \
